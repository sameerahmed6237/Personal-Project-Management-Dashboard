...
| :--- | :--- |
| **Project Name** | **Personal Project Management Dashboard** |
...
| **Conditional Creation** | Implemented logic to automatically **create a Google Calendar event** with specific deadlines the moment a task is assigned in the relational database. |
...
| Category | Tools Used |
| :--- | :--- |
| **Database Design** | **Airtable** (Relational Database, used as the primary source of truth) |
| **Process Automation** | **Zapier / Make.com** (Workflow Orchestration Engine) |
| **Service Integration** | **Google Calendar API** (for event creation and deletion) |
